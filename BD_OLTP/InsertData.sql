...
(1, 1, DATEADD(DAY, -10, GETDATE())),  -- Hace 10 días
(2, 2, DATEADD(DAY, -9, GETDATE())),   -- Hace 9 días
(3, 3, DATEADD(DAY, -8, GETDATE())),   -- Hace 8 días
(4, 4, DATEADD(DAY, -7, GETDATE())),   -- Hace 7 días
(5, 5, DATEADD(DAY, -6, GETDATE())),   -- Hace 6 días
(1, 2, DATEADD(DAY, -5, GETDATE())),   -- Hace 5 días
(2, 3, DATEADD(DAY, -4, GETDATE())),   -- Hace 4 días
(3, 4, DATEADD(DAY, -3, GETDATE())),   -- Hace 3 días
(4, 5, DATEADD(DAY, -2, GETDATE())),   -- Hace 2 días
